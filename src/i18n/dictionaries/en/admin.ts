const admin = {
  ...
  serviceCertification: {
    ...
    create: {
      ...
      helpers: {
        status: "Enable if this certification item should appear on the service page.",
        orderIndex: "Display order inside certification list. Smaller value appears first.",
        title: "Certification title shown to users.",
        altText: "Alternative text for accessibility and image fallback.",
        caption: "Optional short supporting caption for this certification.",
      },
    },
    detail: {
      ...
      helpers: {
        languageTabs: "Choose which certification translation language you want to edit.",
        status: "Enable if this certification item should appear on the service page.",
        orderIndex: "Display order inside certification list. Smaller value appears first.",
        title: "Certification title shown to users.",
        altText: "Alternative text for accessibility and image fallback.",
  ...
  serviceMatrix: {
    ...
    create: {
      ...
      previewHint: "If the table is too tight, scroll horizontally left/right.",
      ...
      fields: {
        ...
        compact: "Compact",
        columns: "Columns",
        rowsCells: "Rows + Cells",
      },
      helpers: {
        title: "Main title for the service matrix comparison table.",
        description: "Short description to explain matrix context.",
        footnote: "Optional note shown below the matrix.",
        status: "Enable if this matrix should be visible on the service page.",
        compact: "Enable compact mode for denser table layout.",
        columns: "List of package/plan columns to compare in this matrix.",
        rowsCells: "Feature rows and each cell value for every column.",
      },
    },
    detail: {
      ...
      helpers: {
        languageTabs: "Choose which matrix translation language you want to edit.",
        title: "Main title for the service matrix comparison table.",
        description: "Short description to explain matrix context.",
        footnote: "Optional note shown below the matrix.",
        status: "Enable if this matrix should be visible on the service page.",
  ...
  serviceGallery: {
    ...
    create: {
      ...
      helpers: {
        status: "Enable if this gallery item should appear on the service page.",
        image: "Main gallery image for this service item.",
        title: "Gallery item title shown to users.",
        altText: "Alternative text for accessibility and image fallback.",
        caption: "Optional short supporting caption for this gallery item.",
      },
    },
    detail: {
      ...
      helpers: {
        languageTabs: "Choose which gallery translation language you want to edit.",
        status: "Enable if this gallery item should appear on the service page.",
        image: "Upload a new image only when replacing current gallery image.",
        title: "Gallery item title shown to users.",
        altText: "Alternative text for accessibility and image fallback.",
        caption: "Optional short supporting caption for this gallery item.",
      },
  ...
  servicePricingTier: {
    ...
    create: {
      titlePrefix: "Create Service Pricing Tier",
      backToList: "Back",
      serviceRequired: "Please pick a service from list page first.",
      submitIdle: "Create",
      submitSaving: "Saving...",
      ...
      helpers: {
        name: "Pricing tier/package name shown to users.",
        description: "Short description for this pricing tier package.",
        features: "List package features, one line for one feature.",
        priceMonthly: "Monthly subscription price.",
        priceYearly: "Yearly subscription price.",
        orderIndex: "Display order for pricing tiers. Smaller value appears first.",
        popular: "Mark this package as highlighted/popular package.",
        status: "Enable if this package should appear on pricing page.",
      },
    },
    detail: {
      ...
      helpers: {
        languageTabs: "Choose which pricing tier translation language you want to edit.",
        name: "Pricing tier/package name shown to users.",
        description: "Short description for this pricing tier package.",
        features: "List package features, one line for one feature.",
        priceMonthly: "Monthly subscription price.",
  ...
  spaceRoom: {
    ...
    create: {
      ...
      backToList: "Back to list",
      defaultLanguageHint: "Master in ID first, EN will be auto-translated by backend",
      ...
      placeholders: {
        ...
        metaKeywords: "Meta keywords (comma separated)",
        alt: "Alt",
        imageTitle: "Title",
      },
      labels: {
      ...
      helpers: {
        status: "Enable if this room should be visible on website.",
        author: "Room data author from currently logged in admin account.",
        code: "Unique room identifier code (internal/admin purpose).",
        capacity: "Maximum room capacity (number of people).",
        floor: "Floor location where the room is located.",
        address: "Full room location/address.",
        title: "Room title shown to visitors.",
        slug: "Auto URL slug generated from title.",
        description: "Detailed room description for public page.",
        metaAuto: "Meta title and description auto-generated from title and description summary.",
        facilities: "Room facilities list, separated by commas.",
        metaKeywords: "SEO keywords, separated by commas.",
        images: "Upload one or more room images and choose the main thumbnail.",
      },
    },
    detail: {
      ...
      fields: {
        ...
        replaceImages: "Replace Images (optional)",
      },
      helpers: {
        status: "Enable if this room should be visible on website.",
        author: "Room data author from currently logged in admin account.",
        ...
        floor: "Floor location where the room is located.",
        address: "Full room location/address.",
        languageTabs: "Choose which room translation language you want to edit.",
        title: "Room title shown to visitors.",
        slug: "Auto URL slug generated from title.",
        description: "Detailed room description for public page.",
        metaAuto: "Meta title and description auto-generated from title and description summary.",
        facilities: "Room facilities list, separated by commas.",
        metaKeywords: "SEO keywords, separated by commas.",
        replaceImages: "When uploading new images on update, old images will be replaced.",
      },
    },
  },
  client: {
  ...
  partner: {
    ...
    create: {
      ...
      fields: {
        orderIndex: "Order Index",
        statusGrid: "Grid Status",
        statusScroller: "Scroller Status",
        image: "Image",
        altText: "Alt Text",
        title: "Title",
        description: "Description",
      ...
      helpers: {
        orderIndex: "Display order for partner list. Smaller value appears first.",
        statusGrid: "Enable if this partner should appear in partner grid mode.",
        statusScroller: "Enable if this partner should appear in partner scroller/carousel.",
        image: "Partner logo/image shown on partner section.",
        altText: "Alternative text for accessibility and image fallback.",
        title: "Partner name or short title for content identification.",
        description: "Optional short description/notes for this partner.",
      },
    },
    detail: {
      ...
      helpers: {
        ...
        statusGrid: "Enable if this partner should appear in partner grid mode.",
        statusScroller: "Enable if this partner should appear in partner scroller/carousel.",
        image: "Upload a new image only when replacing current partner logo.",
        languageTabs: "Choose which partner translation language you want to edit.",
        altText: "Alternative text for accessibility and image fallback.",
        title: "Partner name or short title for content identification.",
        description: "Optional short description/notes for this partner.",
      },
  ...
  user: {
    ...
    create: {
      ...
      helpers: {
        email: "Primary user email used for login and account communication.",
        username: "Unique username as user account identity.",
        fullName: "User full name for profile and internal data display.",
        password: "Initial password for newly created user account.",
        role: "User access permission in system based on selected role.",
      },
    },
    detail: {
      ...
      helpers: {
        ...
        password: "Fill only if you want to change password. Leave empty to keep current password.",
        role: "User access permission in system based on selected role.",
        active: "Enable if user account is allowed to sign in and use the system.",
        emailVerified: "Mark whether this user email has been verified.",
      },
    },
  },
  hero: {
