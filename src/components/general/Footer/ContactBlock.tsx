      ...
      <div className="space-y-5">
        <div className="flex items-center gap-2">
          <span className="relative w-[20px] h-[20px]">
            <Image src="/images/general/footer/building.webp" alt="building" fill className="object-contain" />
          </span>
        ...
        <div>
          <Link href="mailto:info@aruraharja.co.id" className="flex items-center gap-2 underline text-[17px]">
            <span className="relative w-[20px] h-[20px]">
              <Image src="/images/general/footer/mail.webp" alt="mail" fill className="object-contain" />
            </span>
