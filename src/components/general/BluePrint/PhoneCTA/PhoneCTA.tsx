    ...
    <div className="rounded-2xl border border-bumnslate-10 bg-white p-6 shadow-bumn-2 text-center">
      ...
      <div className="mt-3 flex flex-wrap items-center justify-center gap-2">
        <a
          ...
          className="inline-flex items-center gap-2 rounded-xl bg-bumn-gradient-primary-11 px-5 py-2.5 text-sm font-semibold text-white hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-bumnblue-5"
        >
