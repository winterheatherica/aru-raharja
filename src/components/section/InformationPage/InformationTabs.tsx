...
export default function InformationTabs({ locale }: { locale: string }) {
  return (
    <div className="w-full mt-6 p-1 rounded-lg inline-flex flex-col items-center justify-center lg:flex-row bg-bumn-white font-sans">
      <Link
      ...
      <Link
        ...
        className="inline-flex items-center justify-center w-full px-2 py-2 h-[44px] lg:h-[77px] text-base font-normal transition-all rounded-md whitespace-normal text-center shadow bg-bumn-2 text-white"
      >
        Annual Report
      </Link>
      <Link
