      ...
      <div className="w-full p-3 pb-0 lg:p-5 lg:pb-0">
        <div className="flex justify-between w-full gap-6">
          <div className="flex items-center space-x-4">
            ...
            <h3 className="text-lg font-bold lg:text-xl line-clamp-2 text-bumngreen-1">
              {item.title}
            </h3>
          </div>
          <p className="font-sans text-base lg:text-lg text-bumngreen-2">{item.date}</p>
        </div>
      </div>

      <div className="w-full p-3 pt-2 pb-1 mt-auto space-y-3 lg:pb-3 lg:p-5 lg:pt-2">
        <div className="mt-auto text-base text-bumnslate-6 font-lato line-clamp-2">
          {item.excerpt}
        </div>

        <Link
          href={item.href}
          className="inline-flex items-center gap-2 text-sm font-medium text-primary underline-offset-4 hover:underline h-9 rounded-full p-0"
        >
